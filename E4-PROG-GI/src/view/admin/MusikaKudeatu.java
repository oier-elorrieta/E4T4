	...
	public MusikaKudeatu() {
		...
		super.btnGehitu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (opcion == JOptionPane.OK_OPTION) {
					...
					Musikaria m = new Musikaria(izena.getText(),desk.getText(),insertatzekoIrudia,(String)cboEzaugarria.getSelectedItem());
		...
		super.btnDatuakAldatu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e){
				...
				int opcion = JOptionPane.showConfirmDialog(null, pan, "Aldatu datuak: ",
						JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
